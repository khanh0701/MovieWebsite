<ul class="list-film">
    ...
    $_get = $_GET['id'];
    $array = array(50);
    $sql = "Select phim.id,phim.tenphim,phim.anhminhhoa,phim.theloai,phim.thoiluongphim,phim.namsanxuat,phim.soluotxem from phim,theloai where phim.theloai=theloai.id and theloai.id=(select theloai from phim where id='$_get') limit 6";
